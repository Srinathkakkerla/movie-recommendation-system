...
def fetch_poster(movie_id):
    url = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=fb35f67c7e2a17423682c139e9db64a1&language=en-US"
...
movies = pickle.load(open('model_data/movie_list.pkl', 'rb'))
similarity = pickle.load(open('model_data/similarity.pkl', 'rb'))
